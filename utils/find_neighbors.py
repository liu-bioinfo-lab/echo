...
with open(dir_path+'adj_matrix/top_adjacency_matrix_2.pickle','rb') as f:
    adjs=pickle.load(f)
...
with open(dir_path+'neighbor_list/neighbor_list_%s_%s.pickle' % (args.k_adj,args.k_neigh), 'wb') as f:
